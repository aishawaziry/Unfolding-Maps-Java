...
public class EarthquakeCityMap extends PApplet {
	...
	// NEW IN MODULE 5
	// i change lastSelected from type commonMarker TO Marker  
...
//		}
		...
		if (lastClicked != null) {
			...
			selectMarkerIfHover(quakeMarkers);
			if (lastSelected != null) {
				lastClicked = (CommonMarker) lastSelected;
				selection();
			}
		}
	...
	private void selection() {
		for (Marker m1 :cityMarkers) {
			if (!(m1.isHidden())&m1.isInside(map, mouseX, mouseY)) {
			...
			for (Marker m3:quakeMarkers) {
				EarthquakeMarker quakeMarker = (EarthquakeMarker)m3;
				if (quakeMarker.getDistanceTo(m1.getLocation())>quakeMarker.threatCircle()) {
