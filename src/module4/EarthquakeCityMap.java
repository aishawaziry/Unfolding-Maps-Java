	...
	private void printQuakes() 
	{
	    ...
	    for (Marker cm: countryMarkers) {
   		 String name = (String)cm.getProperty("name");
	    	 ...
	    	 if( countryEarthquake>0) {
    			 System.out.println(name+" "+countryEarthquake);
    		 }
  		 countryEarthquake=0;
	    	 int oceanCounter=0;
	    	 for (PointFeature f:earthquakes ) {
	    	 ...
	    	 System.out.println("Number of oceans earth quake "+oceanCounter);
	    }
